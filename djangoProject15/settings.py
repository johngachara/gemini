...
SECRET_KEY = "django-insecure-eoj%g!=i(98hth_)1#h66k7g*kpogh(sxhj9p(ywousu*&y8xy"
...
DATABASES = {
    'default': {
        ...
        'HOST': '',  # Usually 'localhost', or specify the server address
...
GEMINI_API_KEY = 'AIzaSyDafLHqDeL4b2cqtj_zDi_YdUyxYEM3-l0'
